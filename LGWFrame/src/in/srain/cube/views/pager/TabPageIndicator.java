...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	private static final boolean DEBUG = DefindConstant.DEBUG_PAGE_INDICATOR;
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < count; i++) {
			...
			if (view.getLayoutParams() == null) {
				mTabLayout.addView(view, new LinearLayout.LayoutParams(
	...
	public void moveToItem(int item) {
		...
		if (DEBUG) {
			LogUtil.dd("mViewPager.setCurrentItem: %s", item);
		}
		if (mListener != null) {
