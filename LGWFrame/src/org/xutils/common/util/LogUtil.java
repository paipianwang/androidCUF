...
public class LogUtil {
	...
	public static void d(String content,Throwable tb) {
		if (!x.isDebug())
			return;
		String tag = generateTag();
		Log.d(tag, content,tb);
	}
	
	
	public static void dd(String content, Object...object) {
		if (!x.isDebug())
			return;
		String tag = generateTag();
		Log.d(tag, String.format(content, object));
	}
